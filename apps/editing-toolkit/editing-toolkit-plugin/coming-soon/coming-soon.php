 ...
 * @param WPCOM_JSON_API_Endpoint $endpoint Local endpoint instance. It's not really used on WP.com - $response comes from
 *                                            corresponding code called on remote site.
